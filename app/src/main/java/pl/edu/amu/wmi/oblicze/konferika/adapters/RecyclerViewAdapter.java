...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {//implements View.OnClickListener {
    ...
    @Override public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(pl.edu.amu.wmi.oblicze.konferika.R.layout.poster_recycler_item, parent, false);
...
//    }
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            image = (ImageView) itemView.findViewById(pl.edu.amu.wmi.oblicze.konferika.R.id.image);
            text = (TextView) itemView.findViewById(pl.edu.amu.wmi.oblicze.konferika.R.id.text);
            author = (TextView) itemView.findViewById(pl.edu.amu.wmi.oblicze.konferika.R.id.poster_author);
            tags = (TextView) itemView.findViewById(pl.edu.amu.wmi.oblicze.konferika.R.id.poster_tags_text_view);
            ratingBar = (RatingBar) itemView.findViewById(pl.edu.amu.wmi.oblicze.konferika.R.id.poster_list_rating_bar);
            idTv = (TextView) itemView.findViewById(pl.edu.amu.wmi.oblicze.konferika.R.id.poster_id_text_view);
        }
